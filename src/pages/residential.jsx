...
export default function Component() {
  ...
  //  --> we can't just show all plans for residential, we need to show plans for the state/network the user is in
  const plans = flagshipPlans.by_customer_type["RESIDENTIAL"];

  return (
    <PageLayout>
      <Helmet>
        <title>Residential Plans - iO Energy</title>
      </Helmet>
        ...
        <Container>
          <Stack>
            ...
            <Typography
              ...
              sx={{ ml: 4 }}
            >
              Beat the cost-of-living by using cleaner and cheaper power,
              smarter.
            </Typography> */}
              <Typography
                variant="h4"
                sx={{ fontWeight: "bold", ml: { md: 4 } }}
              >
                Signup
                <BrandDot />
              </Typography>
              ...
              <Typography variant="body1" sx={{ mt: 1.5, ml: { md: 4 } }}>
                ...
                <Link
                  ...
                  href={`mailto:hello@ioenergy.com.au?subject=${encodeURIComponent(
                    ...
                    "Hi iO Energy team,\n\nI'd like to join once the Energy Locals transfer is complete.\n\nMy mobile number is: +61________\n\nThanks!",
                  )}`}
                  color="inherit"
                  underline="always"
                >
